...
<body style="background-image:url('https://www.thesparksfoundationsingapore.org/images/bg3.jpg'); no-repeat fixed center; padding:20px;">
    <?php include 'db.php'; ?>
        ...
        <div class="collapse navbar-collapse ex2" id="navbarSupportedContent">
            <b>
                <ul class="navbar-nav ">
                    ...
                    <li class="nav-item" style="margin-left:15px;">
                        <a class="nav-link text-nowrap active" href="contact.php">Contact Us</a>
                    </li>
...
?>
    ...
    <center>
        <div class="container" style="padding:10px 80px 10px 80px; margin-top:2%;">
            <div
                style="width:80%; background-color:rgba(0,0,0,.5); padding:5px 5px 5px 5px; border-radius:30px; box-shadow: 2px 2px 10px gray; margin-top:40px;">
