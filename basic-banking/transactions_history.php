...
<head>
    ...
    <script src="//maxcdn.bootstrapcdn.com/bootstrap/4.1.1/js/img src="img/logo.png" alt="" style="height: 80px.min.js"></script>
        ...
        <div class="collapse navbar-collapse ex2" id="navbarSupportedContent">
            <b>
                <ul class="navbar-nav ">
                    ...
                    <li class="nav-item" style="margin-left:15px;">
                        <a class="nav-link text-nowrap active" href="transactions_history.php">Transactions</a>
                    </li>
                    <li class="nav-item" style="margin-left:15px;">
