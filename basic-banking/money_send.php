...
<body style="background-color:#1d6141; padding-top:8%;">
            ...
            <b>
                <ul class="navbar-nav ">
                    ...
                    <li class="nav-item" style="margin-left:15px; ">
                        <a class="nav-link text-nowrap active" href="money_send.php">Send Money</a>
                    </li>
                    <li class="nav-item" style="margin-left:15px;">
    ...
    <center>
        ...
        <div class="container" style="margin-top:2%;">
            ...
            <div class="" style=" backdrop-filter: blur(5px);  border-radius:5px;  ">
                <form action="money_send.php" method="post">
                    <table>
                        <tr>
                    ...
                    <p style="color:white;">Want to check your balance? check <a href="balance_check.php">here</a></p>
                </form>
            </div>
        </div>
