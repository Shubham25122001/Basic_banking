...
<body class="body-bg">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed fixed-top"
        ...
        <div class="container-fluid">
            <a href="index.php"><img src="img/logo.png" alt=""
                    style="height: 80px; margin-left:25px; margin-top:10px; background-color: #f9fafb"></a>
            ...
            <b>
                <ul class="navbar-nav ">
                    ...
                    <li class="nav-item" style="margin-left:15px; margin-right:75px;">
                        <a class="nav-link text-nowrap active" href="about.php">About Us</a>
                    </li>
                </ul>
            </b>
        </div>
    ...
    <center>
        <div class="container" style="margin-top: 9%; padding:10px 80px 10px 80px; ">
            ...
            <br><br>
            <img src="img/shubham.png" alt="" style=" border-radius: 28%; width:20%; box-shadow:2px 2px 15px black;">
            <br><br>
            <p style="color:white;">This website is created by</p>
            <h1 style="color:white; text-shadow:2px 2px 2px gray;">Shubham Verma</h1>
            <p style="color:white;"><b>Intern at Sparks Foundation <br><a href="https://uitrgpv.ac.in" style="color: green;">University Institute of Technology, RGPV Bhopal </a></b></p>
    </center>
